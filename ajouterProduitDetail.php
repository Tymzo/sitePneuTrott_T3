...
<body style="/*background: url(" design.jpg");*/background-position: 0 -60px;">
    <form action="donnees_produit_maj_process.php" method="post">
            ...
            <div class="container py-5">
                ...
                <div class="row justify-content-center">
                    <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item" style="padding-right: 36px;">
                        <div class="mb-3"><input class="form-control form-control-sm" type="text" name="nom" id="nom" value="<?= htmlspecialchars($produit['PRO_NOM']) ?>"></div>
                        <ul class="list-unstyled">
                            <li></li>

                            <div class="mb-3"><input class="form-control form-control-sm" type="float" name="prixUnitaire" id="prixUnitaire" value="<?= htmlspecialchars($produit['PRO_PRIXUNITAIRE']) ?>"></div>
                            <ul class="list-unstyled">
                                <li></li>

                                <div class="mb-3"><input class="form-control form-control-sm" type="number" name="qtestock" id="qtestock" value="<?= htmlspecialchars($produit['PRO_QTESTOCK']) ?>"></div>
                                <ul class="list-unstyled">
                                    <li></li>
                    ...
                    <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item" style="padding-right: 36px;">
                        <div class="mb-3"><textarea class="form-control form-control-sm" id="message-1" name="descriptionProduit" rows="6" id="descriptionProduit" placeholder="<?= htmlspecialchars($produit['PRO_DESC']) ?>"></textarea>
                        </div>
                        <ul class="list-unstyled">
                            <li></li>
                    </div>
                    <div class="row justify-content-center">
                        <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item" style="padding-right: 36px;">
                            <input class="btn btn-primary shadow" type="submit" name="ajout" value="Enregistrer"></a>
                            <ul class="list-unstyled">
                                <li></li>
                        </div>
                        <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item" style="padding-right: 36px;">
                            <input class="btn btn-primary shadow" type="reset"></input>
                            <ul class="list-unstyled">
                                <li></li>
                        </div>