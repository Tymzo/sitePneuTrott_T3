        ...
        <div class="container py-5">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    ...
                    <p class="text-muted w-lg-50">Souhaitez-vous modifier votre profil ?&nbsp;</p>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item" style="padding-right: 36px;">
                <a class="btn btn-primary shadow" role="button" href="gestionProfil.php">Gestion de profil</a>
                <ul class="list-unstyled">
                    <li></li>
            </div>
            <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item" style="padding-right: 36px;">
                <a class="btn btn-primary shadow" role="button" href="historiqueCommande.php">Historique de commande</a>
                <ul class="list-unstyled">
                    <li></li>
            </div>
