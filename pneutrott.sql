...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 16 sep. 2022 à 06:50
...
CREATE TABLE IF NOT EXISTS `adresse` (
  ...
  `ADR_NPA` int(4) NOT NULL,
  `ADR_LOCALITE` varchar(30) NOT NULL,
...
INSERT INTO `adresse` (`ADR_ID`, `ADR_NPA`, `ADR_LOCALITE`, `ADR_PAYS`, `ADR_RUE`) VALUES
(1, 1208, 'Genève', 'CH', 'Rue Le-Corbusier 21'),
(2, 1208, 'Genève', 'CH', 'Rue Le-Corbusier 21'),
(3, 1208, 'Genève', 'CH', 'Rue Le-Corbusier 21');
...
CREATE TABLE IF NOT EXISTS `commande` (
  ...
  `ADR_LIVRAISON` int(11) NOT NULL,
  `COM_DATE` date NOT NULL,
  `COM_DATEHEURE` datetime NOT NULL,
  `COM_STATUT` varchar(20) NOT NULL,
  PRIMARY KEY (`COM_ID`),
  KEY `ADR_ID` (`ADR_LIVRAISON`),
  KEY `ADR_LIVRAISON` (`ADR_LIVRAISON`)
...
CREATE TABLE IF NOT EXISTS `facture` (
  ...
  `FAC_STATUT` varchar(32) NOT NULL,
  `FAC_NO` int(5) NOT NULL,
  `FAC_ADRESSE` varchar(50) NOT NULL,
  `FAC_NPA` int(4) NOT NULL,
  `FAC_LOCALITE` varchar(30) NOT NULL,
  `FAC_PAYS` varchar(30) NOT NULL,
  PRIMARY KEY (`FAC_ID`),
  KEY `COM_ID` (`COM_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `personne` (
  ...
  `PER_NOAVS` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`PER_ID`),
  KEY `ADR_ID` (`ADR_DOMICILE`),
  KEY `ADR_ID_2` (`ADR_DOMICILE`),
  KEY `ADR_DOMICILE` (`ADR_DOMICILE`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
INSERT INTO `personne` (`PER_ID`, `ADR_DOMICILE`, `PER_NOM`, `PER_PRENOM`, `PER_EMAIL`, `PER_TYPE`, `PER_DATENAISSANCE`, `PER_MDP`, `PER_NOAVS`) VALUES
(1, 2, 'Admin', 'Luis', 'luis.admin@gmail.com', '0', '2000-05-05', '$2y$12$l6nC9HMJ5eJ8RmfShy3uB.kqqoPmyBvF2mWKMB.Lf37/20L2VpGMW', NULL),
(2, 3, 'admin', 'ahmed', 'ahmed@gmail.com', '0', '2001-08-07', '$2y$12$u2.GDKqqIvUmuuhVt1B/.eK5zq9GuPztmXI9YoglTKTTtZABe5gAm', NULL);
...
CREATE TABLE IF NOT EXISTS `produit` (
  ...
  `PRO_PRIXUNITAIRE` float NOT NULL,
  `PRO_IMAGE` varchar(500) NOT NULL,
  `PRO_QTESTOCK` int(4) NOT NULL,
...
INSERT INTO `produit` (`PRO_ID`, `CAT_ID`, `PRO_NOM`, `PRO_DESC`, `PRO_PRIXUNITAIRE`, `PRO_IMAGE`, `PRO_QTESTOCK`, `PRO_VISIBLE`) VALUES
(3, 1, 'Pneu de trottinette', 'Un joli pneu de trottinnette XXL.', 28, 'PneuDeTrottinette.jpg', 4, NULL),
(5, 2, 'Guidon de trott', 'aksdjlkajsdlkjadsklj', 10, 'Guidon-trottinette-electrique.jpeg', 20, NULL),
(8, 1, 'EMAN', 'UN PNEU', 10, '241f6ed494028c787e5db3982cd05b25.jpg', 1, NULL),
(9, 1, 'ddfdfdfdf', 'dfghjk', 123, 'wallpapersden.com_tanjirou-kamado-manga_2560x1440.jpg', 123445, NULL),
(10, 1, 'fdgsdfg', '12312312312', 123, 'Vinland.Saga.full.2706450.jpg', 123, NULL),
(11, 1, 'q34q3432', '123123123123', 123, '06d647c9784ff5c0dafb3589f378cd91.jpg', 123, NULL),
(12, 1, '323131', 'gdfffffff', 123123000, '8d022be75f7a628db84bc12d1f4474bf.jpg', 123, NULL),
(13, 1, 'Luqman', 'sdftzgsbhfnshdvbzdshbvhdsbjv', 190, '5543656.jpg', 1, NULL);

-- --------------------------------------------------------

--
-- Structure de la table `produitCommander`
--
...
ALTER TABLE `commande`
  ADD CONSTRAINT `commande_ibfk_1` FOREIGN KEY (`ADR_LIVRAISON`) REFERENCES `adresse` (`ADR_ID`);

--
-- Contraintes pour la table `facture`
--
ALTER TABLE `facture`
  ADD CONSTRAINT `facture_ibfk_1` FOREIGN KEY (`COM_ID`) REFERENCES `commande` (`COM_ID`);

--
-- Contraintes pour la table `personne`
--
ALTER TABLE `personne`
  ADD CONSTRAINT `personne_ibfk_1` FOREIGN KEY (`ADR_DOMICILE`) REFERENCES `adresse` (`ADR_ID`);

--
-- Contraintes pour la table `produit`
--
ALTER TABLE `produit`
  ADD CONSTRAINT `produit_ibfk_1` FOREIGN KEY (`CAT_ID`) REFERENCES `categorie` (`CAT_ID`);

--
-- Contraintes pour la table `produitcommander`
--
ALTER TABLE `produitCommander`
  ADD CONSTRAINT `produitCommander` FOREIGN KEY (`COM_ID`) REFERENCES `commande` (`COM_ID`),
  ADD CONSTRAINT `produitCommander` FOREIGN KEY (`PRO_ID`) REFERENCES `produit` (`PRO_ID`);
COMMIT;
