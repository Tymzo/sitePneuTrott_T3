...
<head>
    ...
    $sqlQuery = 'SELECT * from commande JOIN personne ON commande.PER_ID = personne.PER_ID WHERE COM_ID = :idCommande ';
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div class="container py-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2 class="fw-bold"> <?php echo $commande['PER_PRENOM'];
                                            echo " " . $commande['PER_NOM'];
                                            ?>
                    </h2>
